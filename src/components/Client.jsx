...
const Client = () => {
    return (
        <div className=''>
            <h3 className='text-center text-2xl font-bold'>Únete a cientos de empresas que ya están usando <br /> Banktrack para ahorrar tiempo y potenciar su negocio</h3>
            <div className='lg:flex flex-wrap justify-center hidden lg:gap-14 w-[85%] mx-auto'>
