                ...
                <div className="hero-content text-center -mt-16 md:-mt-36">
                    <div className="max-w-3xl">
                        ...
                        <div className='flex justify-center gap-3 flex-col md:flex-row'>
                            <Link href="/registrarse"><button className="btn border-none bg-[#4021C8] text-white rounded-full btn-lg px-10 w-full"><div>Empieza gratis</div></button></Link>
                            <button className="btn border-none rounded-full btn-lg px-10 bg-white text-[#4021C8]"><div className='flex gap-1 justify-center items-center'><CiCalendar className='text-[#4021C8] text-3xl w-8' />Agendar demo</div></button>
                        </div>
