...
//                     className={`btn ${activeButton === 1 ? "border-[#4021C8] border-2" : "border-none"} rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg`}
//                 >
//                     Empresas
//                 </button>
...
//                     className={`btn ${activeButton === 2 ? "border-[#4021C8] border-2" : "border-none"} rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg`}
//                 >
//                     Autónomos
//                 </button>
...
//                     className={`btn ${activeButton === 3 ? "border-[#4021C8] border-2" : "border-none"} rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg`}
//                 >
//                     Particulares
//                 </button>
...
//                     <Image src="/who_1.png" width="500" height="500" alt="" className='lg:rounded-r-3xl w-full h-[30rem] md:h-[48rem]' />
//                 </div>
