    ...
    return (
        <div className='text-center w-full my-20' id="soluciones">
            ...
            <div className='flex gap-2 md:gap-5 justify-center md:flex-row '>
                <button className='btn rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg'>Empresas</button>
                <button className='btn rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg'>Autónomos</button>
                <button className='btn rounded-full text-base px-4 md:px-10 bg-transparent shadow-xl md:btn-lg'>Particulares</button>
            </div>
